...
from sqlalchemy.dialects.mysql import INTEGER as MYSQL_INTEGER  # 关键：MySQL 无符号整型
...
class MatchPlayerStats(Base):
    ...
    # 外键全部与被引用表对齐（matches/players/teams 的 id 都是 INT UNSIGNED）
